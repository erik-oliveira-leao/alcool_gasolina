...
flutter run
~~~
## Depois escolha em qual device vai ser execultado<br>
Connected devices:<br>
Windows (desktop) • windows • windows-x64    • Microsoft Windows [versÆo 10.0.26200.8116]<br>
Chrome (web)      • chrome  • web-javascript • Google Chrome 146.0.7680.165<br>
Edge (web)        • edge    • web-javascript • Microsoft Edge 146.0.3856.84<br>
[1]: Windows (windows)<br>
[2]: Chrome (chrome)<br>
[3]: Edge (edge)<br>
Please choose one (or "q" to quit): <br>

## Mudando para Mobile

![Texto Alternativo](img/device.png)

- No canto inferior direito clicar em Windows (windows-x64)<br>
